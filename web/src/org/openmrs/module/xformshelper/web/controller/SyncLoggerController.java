...
public class SyncLoggerController {
	...
	@RequestMapping(value = "/module/xformshelper/syncLog", method = RequestMethod.GET)
	public String showPage(ModelMap model) throws Exception {
		XformsHelperService mfs = (XformsHelperService)Context.getService(XformsHelperService.class);
		...
		return "/module/xformshelper/syncLog";
	}
